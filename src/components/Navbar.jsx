    ...
    <nav className="navbar fixed w-full z-10 bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <img src="/image/urban_logo.webp" alt="Logo" className="h-8" />
          </div>

          <div className="hidden md:flex max-md:space-x-6">
            <a href="#" className="text-gray-700">Beauty</a>
            <a href="#" className="text-gray-700">Wellpanels</a>
            <a href="#" className="text-gray-700">Native</a>
          </div>

          <div className="flex gap-2">
            <input className="border h-10 px-3 max-md:w-[20vw] rounded-md" placeholder="Search " />
            <input className="border max-md:hidden h-10 px-3 rounded-md" placeholder="Search " />
          </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 bg-white border-t border-gray-200">
          <a href="#" className="block text-gray-700">Beauty</a>
          <a href="#" className="block text-gray-700">Wellpanels</a>
          <a href="#" className="block text-gray-700">Native</a>
        </div>
      )}
    </nav>
  );
